...
ws["A1"] = "CORTEVA AGRISCIENCE  —  ANALYTICS PLATFORM SEPARATION MIGRATION CHECKLIST"
...
ws["A3"] = (
    ...
    "BLUE = Delegate to Jake/SAS Admin/IT     AMBER = Joint / collaborative          "
...
rows = [
    ...
    (1,"Review all materials from Saritha & Jake interviews",
       "Notes consolidated; open questions logged; nothing assumed",
       "0 · Pre-Start","You","No","Not Started","All",
       "Include CMDB fragmentation finding from Jake as a Day 1 risk item",C_SOLO),
    ...
    (3,"Schedule kick-off with Saritha and Jake",
    ...
    (4,"Obtain environment access: Dev, Sandbox, Prod",
       ...
       "0 · Pre-Start","Jake / IT","Yes","Not Started","SAS / Spotfire / PBI",
       "Delegate request to Jake; follow up daily until resolved",C_DELEGATE),
    (5,"Confirm target Windows Server version with Saritha and Jake",
       "Written agreement on OS target version (2022, 2025, or other); documented and signed off",
       "0 · Pre-Start","You + Saritha + Jake","No","Not Started","Infrastructure",
       "Jake indicated latest supported version may be target — get this confirmed in writing before any planning. Current latest is Server 2025.",C_JOINT),
    ...
    (6,"Document current SAS environment (version, host, config, scheduled jobs)",
       ...
       "Jake has been primary SAS admin ~2.5 years since predecessor retired — no formal handoff occurred. Gaps are likely.",C_JOINT),
    (7,"Document current Spotfire environment (version, host, data connections, auth)",
       ...
       "1 · Discovery","Jake","Yes","Not Started","Spotfire",
       "Jake leads; you validate output against what you expect to see",C_DELEGATE),
    (8,"Document current Power BI Gateway (version, data sources, credentials, auth)",
       ...
       "1 · Discovery","Jake","Yes","Not Started","Power BI",
    ...
    (9,"Audit and consolidate dependency tracking across all platforms",
       ...
       "1 · Discovery","You + Jake","No","Not Started","All",
       "IMPORTANT: Jake indicated dependency tracking is fragmented with no single source of truth — 'all over the place.' There is no reliable CMDB baseline to start from. Audit ALL sources (ServiceNow if present, Datadog, spreadsheets, tribal knowledge) and build a unified map before touching anything.",C_JOINT),
    ...
    (11,"Inventory all servers in scope for OS upgrade and separation",
       ...
       "1 · Discovery","Jake / IT","Yes","Not Started","Infrastructure",
       "Scope: how many servers total? All 3 platforms on same hosts or separate?",C_DELEGATE),
    (12,"Assess all documentation gaps and flag risks to Saritha",
       "Gap report delivered; risks ranked; Saritha has acknowledged and prioritized",
    ...
    (13,"Confirm OS upgrade sequence: upgrade first, then separate (as Jake agreed)",
       "Written agreement that OS upgrade precedes separation work; sequencing documented",
       "2 · Planning","You + Saritha + Jake","No","Not Started","Infrastructure",
       "Jake agreed: upgrade OS before doing the spinoff separation. Lock this in writing.",C_JOINT),
    (14,"Confirm target OS version and obtain IT approval",
       ...
       "2 · Planning","Saritha + IT","No","Not Started","Infrastructure",
       "Delegate approval to Saritha; you need the answer before build work begins",C_DELEGATE),
    (15,"Build consolidated dependency map as single source of truth",
       "All platform dependencies, DB connections, service accounts, and AD groups in one verified document; Jake and Saritha sign off",
       "2 · Planning","You","No","Not Started","All",
       "This replaces the fragmented tracking Jake described. Non-negotiable foundation for safe migration.",C_SOLO),
    (16,"Confirm migration sequence across platforms (SAS / Spotfire / PBI order)",
       "Agreed platform migration order documented and signed off by Saritha",
       "2 · Planning","You + Saritha","No","Not Started","All",
    ...
    (17,"Build rollback plan for each platform and each environment tier",
       "Rollback steps documented for Dev, Sandbox, and Prod for all 3 platforms; reviewed by Jake",
    ...
    (18,"Establish change control process for migration duration",
       "Change log template in place; agreed tool (Jira or equivalent) configured; Jake and Saritha aware",
       "2 · Planning","You","No","Not Started","All",
    ...
    (20,"Review and validate Saritha's migration playbook draft",
       "Playbook reviewed; gaps annotated; feedback returned to Saritha",
       "2 · Planning","You + Saritha","Yes","Not Started","All",
       "Playbook was in progress per Saritha — do not wait for final version",C_JOINT),
    (21,"Prepare and present 2-week next-steps plan to Saritha and Jake",
       "Presentation delivered within 2 weeks of start; plan accepted or revised with agreement",
       "2 · Planning","You","No","Not Started","All",
       "Jake specifically requested this deliverable. Include OS upgrade sequencing, separation scope (~140 users / new IT domain), and dependency audit findings.",C_SOLO),
    (22,"Define success criteria and sign-off process for each environment",
       "Written definition of done for Dev, Sandbox, and Prod accepted by Saritha",
       "2 · Planning","You + Saritha","No","Not Started","All",
    ...
    (23,"Stand up new Windows Server (target version) for each platform in Dev",
       ...
       "3 · OS Upgrade","IT / Jake","Yes","Not Started","Infrastructure",
    ...
    (25,"Migrate Spotfire to upgraded OS in Dev; validate connections and auth",
       ...
       "3 · OS Upgrade","Jake","Yes","Not Started","Spotfire",
       "Jake leads; you validate",C_DELEGATE),
    (26,"Migrate Power BI Gateway to upgraded OS in Dev; validate all data sources",
       ...
       "3 · OS Upgrade","You + Jake","Yes","Not Started","Power BI",
    ...
    (27,"Promote OS upgrade through Sandbox and Prod with full regression each tier",
       "All platforms running on upgraded OS in Sandbox and Prod; full regression passed; Saritha sign-off obtained",
       "3 · OS Upgrade","You + Jake + Saritha","No","Not Started","All",
    ...
    (28,"Stand up new separated Dev environment in new IT domain",
       ...
       "4 · Dev Separation","IT / Jake","Yes","Not Started","Infrastructure",
    ...
    (30,"Install and configure Spotfire in separated Dev on new domain",
       ...
       "4 · Dev Separation","Jake","Yes","Not Started","Spotfire",
       "Jake leads; you validate against Phase 1 documentation",C_DELEGATE),
    (31,"Install and configure Power BI Gateway in separated Dev on new domain",
       ...
       "4 · Dev Separation","You + Jake","Yes","Not Started","Power BI",
    ...
    (35,"Stand up separated Sandbox environment in new IT domain",
       ...
       "5 · Sandbox","IT / Jake","Yes","Not Started","Infrastructure",
    ...
    (36,"Promote all platform configs from separated Dev to separated Sandbox",
       ...
       "5 · Sandbox","You + Jake","No","Not Started","All",
    ...
    (38,"Full UAT in separated Sandbox with ~140 affected users / stakeholders",
       ...
       "5 · Sandbox","Saritha / Users","Yes","Not Started","All",
       "Saritha owns sign-off; you support and document results",C_DELEGATE),
    (39,"Sandbox sign-off from Saritha before Prod cutover",
       "Written sign-off from Saritha confirming Sandbox separation complete",
       "5 · Sandbox","Saritha","No","Not Started","All",
    ...
    (40,"Schedule Prod cutover window; communicate to all ~140 affected users",
       ...
       "6 · Prod Cutover","You + Saritha","No","Not Started","All",
    ...
    (42,"Stand up separated Prod environment in new IT domain",
       ...
       "6 · Prod Cutover","IT / Jake","No","Not Started","Infrastructure",
    ...
    (43,"Promote all platform configs to separated Prod via change control",
       ...
       "6 · Prod Cutover","You + Jake","No","Not Started","All",
    ...
    (45,"Go / No-Go decision with Saritha at rollback decision point",
    ...
    (47,"Monitor platform health for 48-72 hours post-cutover",
       ...
       "7 · Validation","You + Jake","No","Not Started","All",
       "Agree on alert routing with Jake during stabilization window",C_JOINT),
    (48,"Confirm availability and monitoring in place for all separated Prod environments",
       "Monitoring configured; availability baseline established; Saritha has visibility",
       "7 · Validation","You","No","Not Started","All",
    ...
    (49,"Collect user feedback from ~140 separated users; resolve reported issues",
       ...
       "7 · Validation","You + Saritha","No","Not Started","All",
       "Establish feedback channel on Day 1 of Prod — don't wait for problems to find you",C_JOINT),
    (50,"Prod sign-off from Saritha",
       "Written sign-off from Saritha confirming separated Prod migration complete and stable",
       "7 · Validation","Saritha","No","Not Started","All",
    ...
    (51,"Finalize consolidated dependency map and hand off as ongoing CMDB baseline",
       "Clean, verified dependency document delivered to Jake and Saritha as the new single source of truth",
    ...
    (52,"Finalize and hand off all migration documentation",
       "Complete runbooks, config docs, change logs delivered to Jake and Saritha",
       "8 · Closeout","You","No","Not Started","All",
    ...
    (53,"Confirm decommission plan for old parent-company environments",
       ...
       "8 · Closeout","Saritha + IT","Yes","Not Started","Infrastructure",
...
legend = [
    ...
    ("Blue — Delegate",             "Assign to Jake, SAS Admin, or IT; you validate output"),
    ("Amber — Joint",               "Requires active input from both you and Corteva"),
    ("", ""),
    ("STATUS", ""),
    ...
    ("", ""),
    ("KEY NOTES", ""),
    ("OS Target",               "Confirmed with Jake: latest supported Windows Server version (2022/2025 TBD). Get written confirmation before planning."),
    ("OS Upgrade Sequencing",   "Jake agreed: upgrade OS first, then execute separation. Phase 3 must complete before Phase 4."),
    ("Dependency Tracking",     "Jake indicated tracking is fragmented — no single source of truth. Phase 1 #9 builds the consolidated map that everything else depends on."),
    ("User Scope",              "~140 users (35% of ~400 total) moving to new IT domain / new company in the separation."),
    ("2-Week Deliverable",      "Jake requested a next-steps presentation within 2 weeks of start. See Phase 2 #21."),
]
...
wb.save("/mnt/user-data/outputs/Corteva_Migration_Checklist.xlsx")
print("Done.")
